    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <router-link :class="route_name == 'pk_local_index' ? 'nav-link active' : 'nav-link'" aria-current="page" :to="{ name: 'pk_local_index' }">本地对战</router-link>
          </li>
          <li class="nav-item">
            <router-link :class="route_name == 'pk_online_index' ? 'nav-link active' : 'nav-link'" aria-current="page" :to="{ name: 'pk_online_index' }">匹配对战</router-link>
          </li>
          <li class="nav-item">
